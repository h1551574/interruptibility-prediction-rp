 ...
 */
public class HexagonFigure extends AttributedFigure {
    /**
    ...
    public HexagonFigure(double x, double y, double width, double height) {
    ...
    protected void drawFill(Graphics2D g) {
        ...
        hexagon.moveTo((float) (r.x + r.width / 2), (float) r.y);
        hexagon.lineTo((float) (r.x + r.width), (float) (r.y + r.height * 1 / 4));
        hexagon.lineTo((float) (r.x + r.width), (float) (r.y + r.height * 3 / 4));
        hexagon.lineTo((float) (r.x + r.width / 2), (float) (r.y + r.height));
        hexagon.lineTo((float) r.x, (float) (r.y + r.height * 3 / 4));
        hexagon.lineTo((float) r.x, (float) (r.y + r.height * 1 / 4));
        hexagon.closePath();
        g.fill(hexagon);
    }
...
// COMPOSITE FIGURES
// CLONING
    public HexagonFigure clone() {
        HexagonFigure that = (HexagonFigure) super.clone();
