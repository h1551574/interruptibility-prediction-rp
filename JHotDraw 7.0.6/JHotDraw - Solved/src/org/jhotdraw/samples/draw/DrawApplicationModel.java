...
public class DrawApplicationModel extends DefaultApplicationModel {
    ...
    public void addDefaultCreationButtonsTo(JToolBar tb, final DrawingEditor editor,
        ...
        ToolBarButtonFactory.addToolTo(tb, editor, new CreationTool(new CircleFigure()), "createCircle", labels);
        ToolBarButtonFactory.addToolTo(tb, editor, new CreationTool(new HexagonFigure()), "createHexagon", labels);
