...
public class PerParticipantValidation5State {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int pi = 1; pi <= NUM_PARTICIPANTS; pi++) {
                String TrainDataset
                        = "C:/Users/alerr/Documents/Masterarbeit/Normalized Data/10/with_pID/CV LOPO 5/" +
                        "norm_inter_data_ALL_10s_pID_3hz_5state_filtered_attributes_train_P"+ pi +".arff";
                ...
                String TestDataset
                        = "C:/Users/alerr/Documents/Masterarbeit/Normalized Data/10/with_pID/CV LOPO 5/" +
                        "norm_inter_data_ALL_10s_pID_3hz_5state_filtered_attributes_test_P"+ pi +".arff";
            ...
            for (int pi = 0; pi < NUM_RUNS; pi++) {
                ...
                for (int ci = 0; ci < NUM_CATEGORIES; ci++) {
                    ...
                    System.out.println("[NB]Confusion Matrix:");
                    System.out.println(Arrays.toString(evalNB.confusionMatrix()[ci]));
                }
            }
