...
public class PerInstanceValidation2StateTWs {
    ...
    public static void RepeatedCrossValidation(String timeWindow) {
        ...
        try {
            ...
            String InterruptionDataset
                    = "C:/Users/alerr/Documents/Masterarbeit/Normalized Data/"+timeWindow+"/with_pID/normalized_interruption_data_ALL_tw_"+timeWindow+"s_pID_3hz_2state_filtered_attributes.arff";
